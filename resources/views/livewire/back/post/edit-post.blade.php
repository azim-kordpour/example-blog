                    ...
                    <form wire:submit="update">
                        <div class="card-body">
                            ...
                            <div class="form-group" wire:ignore wire:key="body_input">
                                <textarea wire:ignore id="body_editor">{{$post->body}}</textarea>
                                <script
                            ...
                            <div class="form-group" wire:ignore wire:key="publish_input">
                                ...
                                <div class="input-group date" id="publish_date" data-target-input="nearest">
                                    <input wire:model="form.published_at" type="text" class="form-control datetimepicker-input">
                                ...
                                @section('headerScripts')
                                    @parent
                                    <link rel="stylesheet" href="{{asset('/back-ui/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}"/>
                                @endsection
                                @section('footerScripts')
                                    @parent
                                    <script type="text/javascript" src="{{asset('/back-ui/plugins/moment/moment.min.js')}}"></script>
                                    <script type="text/javascript" src="{{asset('/back-ui/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script>
                                    <script>
                                        $(function () {
                                        ...
                                        $("#publish_date").on("change.datetimepicker", ({date, oldDate}) => {
                                            @this.set('form.published_at', date.format('yy-MM-DD HH:mm:ss'));
                                        })
                            ...
                            <div class="form-group" wire:ignore wire:key="category_input">
                                ...
                                <select wire:model="form.categories" class="select2bs4" id="categories" multiple data-placeholder="Select a Category" style="width: 100%;" data-select2-id="23" tabindex="-1" aria-hidden="true">
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('.select2bs4').select2().on("change", function (e) {
                                                @this.set('form.categories', $('.select2bs4').val());
                                            });
                                        });
                                    </script>
                                @endsection
