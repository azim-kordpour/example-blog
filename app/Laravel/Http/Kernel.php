...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // \App\Laravel\Http\Middleware\TrustHosts::class,
        \App\Laravel\Http\Middleware\TrustProxies::class,
        \Illuminate\Http\Middleware\HandleCors::class,
        \App\Laravel\Http\Middleware\PreventRequestsDuringMaintenance::class,
    ...
    protected $middlewareAliases = [
        'auth' => \App\Laravel\Http\Middleware\Authenticate::class,
        ...
        'signed' => \App\Laravel\Http\Middleware\ValidateSignature::class,
